...
from data.employee import generate_employee_data
...
if __name__ == "__main__":
    ...
    st.set_page_config(page_title="InnovateTech Solutions", page_icon="🧊", layout="wide", initial_sidebar_state="expanded")
    ...
    vector_store = init_vector_store("./data/Innotech.pdf")
